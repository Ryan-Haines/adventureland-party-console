...
export interface Member {
  ...
  status?: {
    ...
    groupedCombat?: { passingEncounters?: PassingEncounter[]; formationRecovery?: FormationRecoveryReport; approach?: ApproachReport; pursuitAck?: string | null; currentAttackers?: CurrentAttacker[];
