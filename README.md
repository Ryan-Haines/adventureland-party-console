...
3. Open [http://localhost:3010](http://localhost:3010) and follow setup to connect your game account and Steam/browser clients, or select characters for headless play.
