...
function fixture(){
 ...
 const c=vm.createContext({Date,Math,Object,String,Number,Promise,passingEncounters:{},peerPassingEncounters:[],passiveGeneratorAttempt:null,
  ...
  fightDeaths:[],currentTravelAttackers:()=>[],navigationIntent:{},convoyTraveling:null,farmingTravelToken:null,movement:{report:()=>null,transition:()=>null},coordinatorClockOffset:0,partyTownActive:false,banking:false,stocking:false,upgrading:false,gatheringActive:false,
